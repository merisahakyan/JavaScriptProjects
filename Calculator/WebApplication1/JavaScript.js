function printValue() {
    //document.getElementById("demo").value = "barev";
    //document.getElementById("new_text").innerHTML = "<p> hello world </p>";
